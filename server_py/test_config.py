...
# Force initial import so load_dotenv runs once, setting env vars in os.environ.
# This ensures monkeypatch.delenv in tests actually removes them.
import server_py.config
